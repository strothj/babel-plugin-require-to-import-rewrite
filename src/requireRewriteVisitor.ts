...
import { types as t, traverse, parse, Visitor, NodePath } from "@babel/core";
...
interface RequireRewriteVisitorState extends FilenameVisitorState {
  requirePathToIdentifierMap: Map<string, t.Identifier>;
  nextImportDeclarationLine: number;
}

export const requireRewriteVisitor: Visitor<RequireRewriteVisitorState> = {
  CallExpression(path) {
